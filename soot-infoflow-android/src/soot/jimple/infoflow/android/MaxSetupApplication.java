...
public class MaxSetupApplication {
	...
	private LayoutMatchingMode layoutMatchingMode = LayoutMatchingMode.MatchAll;
	...
	public void calculateSourcesSinksEntrypoints
		...
		// Look in ALL implemented callback methods -> increases effort
		for(Entry<String, Set<AndroidMethod>> callbackMethod : jimpleClass.getCallbackMethods().entrySet())
		{
			this.callbackMethods.put(callbackMethod.getKey(), callbackMethod.getValue());
		}
	 ...
	 */
	public LoadTimeInfoflow runInfoflow(String configName){
		return runInfoflow(null, configName);
	}
	 ...
	 * @return The results of the data flow analysis
	 */
	public LoadTimeInfoflow runInfoflow(ResultsAvailableHandler onResultsAvailable, String configName){
