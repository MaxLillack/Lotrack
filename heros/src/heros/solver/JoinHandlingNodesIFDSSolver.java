...
public class JoinHandlingNodesIFDSSolver<N, D extends JoinHandlingNode<D>, M, I extends InterproceduralCFG<N, M>> extends IFDSSolver<N, D, M, I> {
	...
	@Override
	protected NewPathEdgeProcessingTask propagate(D sourceVal, N target, D targetVal, EdgeFunction<IFDSSolver.BinaryDomain> f, N relatedCallSite, boolean isUnbalancedReturn, Collection<N> joinPoints) {
		...
		if (propagate)
			return super.propagate(sourceVal, target, targetVal, f, relatedCallSite, isUnbalancedReturn, joinPoints);
		return null;
	};
